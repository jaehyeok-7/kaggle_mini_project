...
- 실제 분석 결과를 통해서 확보한 변수들의 내용을 기재
- 총 변수갯수 : 31개

## 3. Problem Definition
- **데이터 특성** : blah
- **분석 방향**
   + 통계 분석 : 다중회귀, 분산분석 , 로지스틱회귀
...
>  **Note** : 최종 대회 결과는 public 0.7255 / 
Private 0.70807 (feat . 1등 점수).

> **Note** : 최종 대회 결과는 public 0.7255 / 
Private 0.70807 (상위 10%).
...
- 00보고서: [대사 지표 간 연관성 분석](report/프로젝트보고서.pdf)
- 분석코드 : [분석코드](분석코드.ipnyb)
